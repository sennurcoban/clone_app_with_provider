...
// verify otp
  ...
  void saveUserDataToFirebaseWithoutImage({
    required BuildContext context,
  ...
  Future saveUserDataToSPTwo() async {
    SharedPreferences s = await SharedPreferences.getInstance();
    await s.setString("user_model", jsonEncode(signUpModel.toMap()));
  }
  ...
  Future getDataFromSpTwo() async {
    SharedPreferences s = await SharedPreferences.getInstance();
    String data = s.getString("user_model") ?? '';
    _signUpModel = SignUpModel.fromMap(jsonDecode(data));
    _uid = _signUpModel!.uid;
    notifyListeners();
  }
  ...
  Future userSignOut() async {
   ...
   Future setBirthday(DateTime dateOfBirth) async {
    ...
    return await s.setString(_keyBirthday, birthday);
  }

  Future<DateTime?> getBirthday() async {
    SharedPreferences s = await SharedPreferences.getInstance();
    final birthday = s.getString(_keyBirthday);
